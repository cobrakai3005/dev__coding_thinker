  ...
  if (loading) {
    return (
      <div className="max-w-5xl p-4 mx-auto flex flex-col gap-2 justify-center items-center w-full">
        <div className="p-3 rounded w-full animate-pulse bg-cyan-950/40 flex flex-col gap-2"></div>
        <div className="p-8 rounded w-full animate-pulse bg-cyan-950/40 flex flex-col gap-2"></div>
        <div className="p-12 rounded w-full animate-pulse bg-cyan-950/40 flex flex-col gap-2"></div>
