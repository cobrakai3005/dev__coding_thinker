      ...
      <div className="w-full max-w-7xl mx-auto p-6 grid gap-14 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {[1, 2, 3, 4, 5, 6].map((el) => (
          <div key={el.id} className="p-4 flex flex-col gap-2">
            <div className="p-3 bg-zinc-400 animate-pulse rounded"></div>
            <div className="p-4 bg-zinc-400 animate-pulse rounded"></div>
            <div className="p-9 bg-zinc-400 animate-pulse rounded"></div>
          </div>
        ))}
